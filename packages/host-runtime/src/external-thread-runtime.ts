...
export class ExternalThreadRuntime {
  ...
  readonly clientTools: (threadId: string, cwd: string) => HarnessClientTools | undefined;
  ...
  constructor(input: {
    clientTools?(threadId: string, cwd: string): HarnessClientTools;
    ...
    this.clientTools = input.clientTools ?? (() => undefined);
